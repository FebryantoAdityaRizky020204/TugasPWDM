<?php 
    ...
    $hotel = $uf->getSingleHotel($idHotel);
    if(empty($hotel)) header('Location: ./index.php');
    $kamar = $uf->getListRoom($idHotel);
                                    ...
                                    <div class="row col-12 g-2">
                                        ...
                                        <div class="col-6">
                                            <div class="room-book">
                                                ...
                                                <a class="book-btn" href="./booking.php?id_kamar=<?= $k['id_kamar'] ?>">BOOKING</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
